...
print (poses_valid_2d[0].shape) # (3136, 17, 2)
print (poses_valid_2d[0].shape[-2]) # 17
print (poses_valid_2d[0].shape[-1]) # 2
print (dataset.skeleton().num_joints())
print (filter_widths) # [3, 3, 3, 3, 3]
print (args.causal) # False
print (args.dropout) # 0.25
print (args.channels) # 1024
print (args.dense) # False
...
if args.render:
    ...
    def fetch_actions(actions):
        ...
        for subject, action in actions:
            ...
            for i in range(len(poses_2d)): # Iterate across cameras
                out_poses_2d.append(poses_2d[i])
                print ('poses_2d[i]:', poses_2d[i].shape)
                assert False
